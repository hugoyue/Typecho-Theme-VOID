...
function themeConfig($form)
{
    ...
    $assetsCDN = new Typecho_Widget_Helper_Form_Element_Text('assetsCDN', null, null, '自定义 CDN', '使用 CDN 来加速主题 assets 目录下的静态资源，这里填写 CDN 地址（填写 assets 目录地址，如：https://cdn.jsdelivr.net/gh/hugoyue/Typecho-Theme-VOID@nightly/assets）。若不知道该选项含义，请默认即可。');
